...
#define CS_HIGH (GPIO_WriteBit(GPIOB, GPIO_Pin_12, 1))
#define CS_LOW (GPIO_WriteBit(GPIOB, GPIO_Pin_12, 0))
...
void SPI_Flash_Init(void)
{
    ...
    SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_8; //144M/16
 ...
 * @return  none
 */
void SPI_Flash_Read(u8 *pBuffer, u32 ReadAddr, u32 size)
{
    u32 i;
